...
void setup()
{
  ...
  void start(const std::string& base_frame)
  {
    ...
    auto request = std::make_shared<workcell_core::srv::LocalizePart::Request>();
...
private:
  // Planning components
  rclcpp::Client<workcell_core::srv::LocalizePart>::SharedPtr vision_client_;
