/** This node receives images from a camera and publishes them
 * Subsribes to:marker msgs / marker_detection.*/
...
public:
  Localizer() : Node("vision_node"),buffer_(this->get_clock()), listener_(buffer_),last_msg_{nullptr}
  {
    ...
    server_ = this->create_service<workcell_core::srv::LocalizePart>(
        "localize_part",
  ...
  void localizePart(workcell_core::srv::LocalizePart::Request::SharedPtr req,
                    workcell_core::srv::LocalizePart::Response::SharedPtr res)
  {
    // Read last message
  ...
  rclcpp::Service<workcell_core::srv::LocalizePart>::SharedPtr server_;
